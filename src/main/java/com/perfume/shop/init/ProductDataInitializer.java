    ...
    public void run(String... args) {
        ...
        List<Product> products = Arrays.asList(
                ...
                createProduct("Dior J'adore", "Dior",
                        "Luxurious floral fragrance with notes of jasmine, rose, and orange blossom.", 150.00, "Women",
                        "Eau de Parfum", 50, 52, 4.7, 189, true,
                        "https://images.unsplash.com/photo-1562181286-d3fee7d55364?w=500"),
                createProduct("Gucci Bloom", "Gucci", "Fresh floral composition with gardenia, tuberose, and jasmine.",
                ...
                createProduct("Tom Ford Black Orchid", "Tom Ford",
                        "Luxurious and sensual fragrance blending black orchid with dark chocolate.", 210.00, "Women",
                        "Eau de Parfum", 50, 28, 4.9, 312, true,
                        "https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=500"),
                createProduct("YSL Mon Paris", "Yves Saint Laurent",
                        "Romantic floral fragrance with notes of rose, peony, and blackcurrant.", 135.00, "Women",
                ...
                createProduct("Dior Sauvage", "Dior",
                        "Fresh and spicy fragrance with ambroxan, pepper, and ambrette seed.", 140.00, "Men",
                ...
                createProduct("Bleu de Chanel", "Chanel",
                        "Sophisticated fragrance with notes of citrus, ginger, and cedar.", 145.00, "Men",
                ...
                createProduct("Creed Aventus", "Creed",
                        "Legendary fragrance with pineapple, blackcurrant, and oakmoss.", 380.00, "Men",
                ...
                createProduct("Versace Eros", "Versace",
                        "Energetic and seductive fragrance with mint, green apple, and tonka bean.", 125.00, "Men",
                ...
                createProduct("Giorgio Armani Code", "Giorgio Armani",
                        "Sophisticated and warm fragrance with iris, ambroxan, and leather.", 130.00, "Men",
                ...
                createProduct("Marc Jacobs Daisy Love", "Marc Jacobs",
                        "Fresh and flirty unisex fragrance with wildflower, white raspberry, and vanilla.", 95.00,
                ...
                createProduct("Jo Malone Wood Sage & Sea Salt", "Jo Malone",
                        "Fresh woody cologne perfect for layering.", 185.00, "Unisex", "Cologne", 100, 45, 4.6, 167,
                        true, "https://images.unsplash.com/photo-1570538108519-280658a16dda?w=500"),
                createProduct("Acqua di Parma Blu Mediterraneo", "Acqua di Parma",
                        "Fresh Mediterranean fragrance with lemon and Sicilian citrus.", 155.00, "Unisex",
                        "Eau de Toilette", 100, 39, 4.5, 145, false,
                        "https://images.unsplash.com/photo-1588405748507-ca7b328e4e1d?w=500"),

                // Limited Edition
                createProduct("Roja Parfums Elixir", "Roja Parfums",
                        "Exquisite luxury fragrance with precious ingredients. Ultra-rare.", 450.00, "Limited Edition",
                        "Parfum", 50, 8, 4.9, 89, true,
                        "https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=500"),
                createProduct("Creed Royal Oud", "Creed", "Precious oud-based fragrance with rose and jasmine.", 420.00,
                ...
                createProduct("Lancôme La Vie Est Belle", "Lancôme",
                        "Best-selling fragrance with praline, iris, and patchouli.", 98.00, "Women", "Eau de Parfum",
                        50, 95, 4.7, 201, true, "https://images.unsplash.com/photo-1569505254788-205b4f368f5f?w=500"),
                createProduct("Hugo Boss Bottled", "Hugo Boss",
                        "Best-selling mens fragrance with apple, cinnamon, and leather.", 92.00, "Men",
                ...
                createProduct("Flowerbomb", "Viktor & Rolf",
                        "Explosive floral fragrance with sambac jasmine and centifolia rose.", 165.00, "Women",
                        "Eau de Parfum", 50, 29, 4.8, 278, true,
                        "https://images.unsplash.com/photo-1577875729629-ed5fdc1d3dc3?w=500"),
                createProduct("Coco Mademoiselle", "Chanel", "Elegant modern floral for the sophisticated woman.",
                ...
                createProduct("Jean Paul Gaultier Le Male", "Jean Paul Gaultier",
                        "Legendary masculine fragrance with mint, jasmine, and amber.", 105.00, "Men",
